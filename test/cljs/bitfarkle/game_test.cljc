...
(deftest test-scoring
  ...
  (testing "Four-of-a-kind"
    (is (= 400 (game/score [2 2 2 2])))
    (is (= 600 (game/score [3 3 3 3])))
    (is (= 800 (game/score [4 4 4 4])))
    (is (= 1000 (game/score [5 5 5 5])))
    (is (= 1200 (game/score [6 6 6 6])))
    (is (= 2000 (game/score [1 1 1 1]))))
  (testing "Five-of-a-kind"
    (is (= 800 (game/score [2 2 2 2 2])))
    (is (= 1200 (game/score [3 3 3 3 3])))
    (is (= 1600 (game/score [4 4 4 4 4])))
    (is (= 2000 (game/score [5 5 5 5 5])))
    (is (= 2400 (game/score [6 6 6 6 6])))
    (is (= 4000 (game/score [1 1 1 1 1]))))
  (testing "Six-of-a-kind"
    (is (= 1600 (game/score [2 2 2 2 2 2])))
    (is (= 2400 (game/score [3 3 3 3 3 3])))
